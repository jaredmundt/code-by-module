...
{
   ofstream theFile;    
   static Logfile* theInstance;  // Handle to singleton
...
Logfile* Logfile::theInstance = 0;     // Handle to singleton
...
int main()
{
   ...
   delay();
   g();
   delete Logfile::getInstance();   // Dangerous!
}
